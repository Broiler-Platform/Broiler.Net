...
async function main() {
  ...
  // ever used on the line. The configured version is the floor that would carry numbers
  // spent outside nuget.org; this repository never used another feed, so its floor is
  // preview.1.
